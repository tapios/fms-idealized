...
#PBS -N analysis2d
#PBS -o ../out_err/out.analysis.$PBS_JOBID
#PBS -e ../out_err/err.analysis.$PBS_JOBID
#PBS -S /bin/csh 
#PBS -V 
#PBS -q default
#PBS -m ae

# See description at run_analysis_moist_2d.readme
...
# file generated by model run script to set exp_name, data_dir, run_name, date_name, run_analysis, fms_home, tmpdir, num_fourier, irun, runs_per_script, days_per_segment, num_segments, i_segment
...
# directories
set analysis_dir   = $fms_home:h/analysis/analysis_2d    # directory with analysis code
set scratch_dir    = /scratch/$USER/${exp_name}/${run_name}     # scratch directory on specific compute node (faster read/write)
set uncombined_dir = ${tmpdir}/${run_name}/output/combine/${date_name} # directory with uncombined input data
...
set mppnccombine   = ${tmpdir}/mppnccombine.ifc # path to the combine executable
set include_dir    = $fms_home/bin/nc_inc 
set template       = $analysis_dir/input/mkmf.template.ifc_fram # machine-specific compilation templates for your platform
...
echo "*** Running ${analysis_dir}/run_analysis_moist_2d for ${date_name} of ${run_name} on $HOSTNAME ***"
