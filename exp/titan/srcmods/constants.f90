...
real, public, parameter :: RADIUS = 2575.0e3   
real, public, parameter :: OMEGA  = 4.56068e-6
real, public, parameter :: GRAV   = 1.35    
real, public, parameter :: RDGAS  = 296.8 
real, public, parameter :: KAPPA  = 2./7.  
real, public, parameter :: CP_AIR = RDGAS/KAPPA 
real, public, parameter :: CP_OCEAN = 3481.0
real, public, parameter :: RHO0    = 4.2262e2
...
real, public, parameter :: RVGAS = 518.3 
!real, public, parameter :: CP_VAPOR = 4.0*RVGAS
real, public, parameter :: DENS_H2O = 422.62 
real, public, parameter :: HLV = 4.9e5   
real, public, parameter :: HLF = 5.868e4   
real, public, parameter :: HLS = 5.6868e5
real, public, parameter :: TFREEZE = 90.6    
...
real, public, parameter :: WTMH2O = 1.6037295E+01 !pjp OK to change value because not used yet.
...
real, public, parameter :: PSTD   = 1.467E+06
real, public, parameter :: PSTD_MKS    = 146700.0
!real, public, parameter :: REARTH  = 2.575E+08 !pjp Not used anywhere. 
...
real, public, parameter :: RHOAIR      = 5.2
real, public, parameter :: ALOGMIN     = -50.0
real, public, parameter :: FREZDK      = 90.6  ! ljj addition
