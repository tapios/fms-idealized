...
real, public, parameter :: RADIUS = 57316.0e3      !  radius of the earth (meters)
real, public, parameter :: OMEGA  = 1.6388e-4     !  rotation rate of planet (1/sec)
real, public, parameter :: GRAV   = 10.55         !  acceleration due to gravity (m/s2)
real, public, parameter :: RDGAS  = 4016.4       !  gas constant for dry air (J/Kg/deg)
