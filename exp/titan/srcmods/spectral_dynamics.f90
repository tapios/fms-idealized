...
real, dimension(2) :: valid_range_t = (/30., 800./)  !(/100.,500./)  LJJ modification
...
subroutine compute_corrections(delta_t, tracer_attributes) !pog
...
100 format(' Integration completed through',i9,' days',i6,' seconds')  ! LJJ modification for large number of days
