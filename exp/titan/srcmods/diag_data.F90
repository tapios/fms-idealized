...
integer, parameter  :: VERY_LARGE_FILE_FREQ = 100000000        ! LJJ modification for large number of days
integer, parameter  :: VERY_LARGE_AXIS_LENGTH = 100000000      ! LJJ modification for large number of days
