...
set template       = $analysis_dir/input/mkmf.template.ifc_euler # machine-specific compilation templates for your platform
...
echo "*** Running ${analysis_dir}/run_analysis_moist_hydro_2d for ${date_name} of ${run_name} on $HOSTNAME ***"
