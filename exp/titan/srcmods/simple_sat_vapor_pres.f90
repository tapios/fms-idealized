...
!
!      uses a Clausius-Clapeyron relation with constant latent heat
!
!-----------------------------------------------------------------------
!
!                               usage
...
! The triple point values for methane in the Titan atmosphere.
! triple point temperature and pressure used in Clausius-Clapeyron formula:
 real, parameter :: T0 = 90.68,         &   ! K
                    e0 = 10600.            ! Pa
